...
if (isset($_GET['Ticket_id'])) {
    ...
    $stmtTicket = $connection->prepare("SELECT * FROM `ticket` WHERE Ticket_id = ?");
    $stmtTicket->execute([$ticketId]); 
    $ticketData = $stmtTicket->fetch(PDO::FETCH_ASSOC);

    if ($ticketData) {
        $eventId = $ticketData['E_id'];
		$purchaseDate = date('d/m/Y', strtotime($ticketData['Purchase_Date']));
        $qrImage = $ticketData['QR_image'];

        $stmtEvent = $connection->prepare("SELECT * FROM `event` WHERE E_id = ?");
        ...
        if ($eventData) {
            ...
            $heureDebut = $eventData['Heure_debut'];
            $dateDebut = $eventData['Date_debut'];
            $prixTicket = $eventData['Prix_ticket'];
        } else {
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="vhls140">
										<ul>
											<li>
												<div class="vdt-list">Facture à <?php echo $name ?></div>
											</li>
								...
								<div class="col-md-6">
									<div class="vhls140">
										<ul>
											...
											<li>
												<div class="vdt-list">Date de commande: <?php echo $purchaseDate; ?></div>
											</li>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td>1</td>
											<td><a href="#" target="_blank"><?php echo $titre ?></a></td>

											<td><?php echo $prixTicket ?> MAD</td>
										...
										<tr>
											...
											<td colspan="5">
												<div class="user_dt_trans text-end pe-xl-4">
													<div class="totalinv2">Total de facture: <?php echo $prixTicket ?> MAD</div>
													<p>Payé via paypal</p>
												</div>
											</td>
										</tr>
									...
									<div class="col-lg-7">
										<div class="event-order-dt p-4">
											...
											<div class="event-order-dt-content">
												...
												<span><?php echo date("D, M d, Y g:i A", strtotime($eventData['Heure_debut'])); ?></span>
												<div class="buyer-name"><?php echo $name ?></div>

												<div class="booking-total-grand">
													Prix : <span><?php echo $prixTicket ?> MAD</span>
												</div>
											</div>
										</div>
									</div>
									<div class="col-lg-5">
										<div class="QR-dt p-4">
											...
											<div class="QR-scanner">
												<img src="images/QRCODE/<?php echo $qrImage; ?>" alt="QR-Ticket-Scanner">
											</div>
