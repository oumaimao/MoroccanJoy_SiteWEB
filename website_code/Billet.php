			...
			<form action="" method="post">
				...
				<div class="d-md-flex flex-wrap align-items-center">
					...
					<div class="ocard-right">
						<button class="pe-4 ps-4 main-btn h_40 w-100" type="submit" name="chercher">Chercher</button>
					</div>
				</div>
			</form>
		</div>
							...
							<table class="table">
								<thead class="thead-dark">
									<tr>
										...
										<th scope="col">Id d'évenement</th>
										<th scope="col" class="w-25">QR_Code</th>
								...
								<tbody>
									...
									if (isset($_POST['chercher'])) {
										...
										$crs = $_POST['crs'];
										$Tickets = $connection->query("SELECT * FROM ticket WHERE Ticket_id like '%$crs%' or Statu like '%$crs%' or User_id like '%$crs%' or E_id like '%$crs%' or prix_tickt like '%$crs%'")->fetchAll(PDO::FETCH_ASSOC);
									...
									?>
										...
										?>
											...
											<td><?php echo $Ticket['Ticket_id'] ?></td>
												<td><?php echo $Ticket['User_id'] ?></td>
												<td><?php echo $Ticket['E_id'] ?></td>
												<td><img style="height: 70px; width:70px;" src="images\QRCODE\<?php echo $Ticket['QR_image']; ?>"></td>



												<td><span class="action-btn btn btn-primary"><a href="Billet_detaille.php?id=<?php echo $Ticket['Ticket_id'] ?>">Détaille</a></span></td>												
												</td>
