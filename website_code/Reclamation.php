		...
		<div class="tab-pane fade active show" id="overview-tab" role="tabpanel">
			<div class="table-card mt-4">
				<div class="main-table">
					...
					$sqlState = $connection->prepare("SELECT * FROM `reclamation`");
										$sqlState->execute();
						...
						<table class="table">
							...
							?>
                                ...
                                <?php
									...
									$slimt=($page-1)*$nnp;
									$reclamations= $connection->query("SELECT * FROM `reclamation` limit $slimt,$nnp ")->fetchAll(PDO::FETCH_ASSOC);
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link"href="Reclamation.php?pre=<?php echo $page?>" aria-label="Previous">
	...
	<?php
										...
										for($btn=1;$btn<=$tp;$btn++){
											?>	
    <li class="page-item"><a class="page-link"href="Reclamation.php?page=<?php echo $btn?>"><?php echo $btn?></a></li>
	<?php
										}
										...
										?>
    <li class="page-item">
      <a class="page-link" href="Reclamation.php?next=<?php echo $page?>" aria-label="Next">
