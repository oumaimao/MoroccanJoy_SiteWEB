...
<div class="wrapper wrapper-body">
	<form action="" method="post">
		<div class="dashboard-wrap-content p-4">
			<h5 class="mb-4">Archive d'évenement demandés</h5>
		...
		<div class="tab-pane fade active show" id="overview-tab" role="tabpanel">
			<div class="table-card mt-4">
				<div class="main-table">
					...
					$sqlState = $connection->prepare("SELECT * FROM `archive_demande`");
										$sqlState->execute();
						...
						<table class="table">
							...
							if(isset($_POST['sear'])){
								...
								$slimt=($page-1)*$nnp;
								$demandes= $connection->query("SELECT * FROM `archive_demande` limit $slimt,$nnp ")->fetchAll(PDO::FETCH_ASSOC);
                            }
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link"href="Archive.php?pre=<?php echo $page?>" aria-label="Previous">
	...
	<?php
										...
										for($btn=1;$btn<=$tp;$btn++){
											?>	
    <li class="page-item"><a class="page-link"href="Archive.php?page=<?php echo $btn?>"><?php echo $btn?></a></li>
	<?php
										}
										...
										?>
    <li class="page-item">
      <a class="page-link" href="Archive.php?next=<?php echo $page?>" aria-label="Next">
