	...
	<div class="dashboard-wrap-content p-4">
		...
		<div class="d-md-flex flex-wrap align-items-center">
			...
			<div class="ocard-right">
				<button class="pe-4 ps-4 main-btn h_40 w-100" type="submit" name="bbb">Chercher</button>
			</div>
		...
		<div class="tab-pane fade active show" id="overview-tab" role="tabpanel">
			<div class="table-card mt-4">
				<div class="main-table">
					...
					$sqlState = $connection->prepare("SELECT * FROM `reservation`");
										$sqlState->execute();
...
<?php
						...
						$slimt=($page-1)*$nnp;
						$Reservations= $connection->query("SELECT * FROM `reservation` limit $slimt,$nnp ")->fetchAll(PDO::FETCH_ASSOC);
						foreach($Reservations as $Reservation){						
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link"href="Resirvation.php?pre=<?php echo $page?>" aria-label="Previous">
	...
	<?php
										...
										for($btn=1;$btn<=$tp;$btn++){
											?>	
    <li class="page-item"><a class="page-link"href="Resirvation.php?page=<?php echo $btn?>"><?php echo $btn?></a></li>
	<?php
										}
										...
										?>
    <li class="page-item">
      <a class="page-link" href="Resirvation.php?next=<?php echo $page?>" aria-label="Next">
