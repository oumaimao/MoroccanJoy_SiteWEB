...
$sqlState = $connection->prepare('SELECT * FROM demande WHERE event_id=?');
    ...
    $sqlState->execute([$evt['event_id'],$evt['n_event'],$evt['event_date'],$evt['event_time'],$evt['event_duration'],$evt['adress1'],$evt['adress2'],$evt['city'],$evt['city'],$evt['zip'],$evt['description'],$evt['image'],$evt['gategorie'],$evt['P_tickts'],$evt['$N_tickts']]);
