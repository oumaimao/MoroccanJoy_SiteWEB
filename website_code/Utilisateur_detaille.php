		...
		<div class="checkout-block">
			<div class="main-card">
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							<div class="form-group mt-4">
								...
								<input class="form-control h_50" readonly name="firstname" type="text" placeholder="" value="<?php echo $data['U_Prenom']; ?>">																								
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
							<div class="form-group mt-4">
						...
						<div class="col-lg-6 col-md-12">
							<div class="form-group mt-4">
								...
								<input class="form-control h_50" name="Bdate" type="text"  value="<?php echo $data['U_dateNaissance']; ?>">																								
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
							<div class="form-group mt-4">
				...
				<div class="container step-footer step-tab-pager mt-4">									
					<a href="Utilisateur.php"><button type="button" class="main-btn min-width btn-hover h_40" style="color:black;">Retourner</button></a>
				</div>
		</div>
